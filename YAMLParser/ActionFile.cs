...
namespace FauxMessages
{
    public class ActionFile
    {
        ...
        public MsgsFile Request;
        public MsgsFile Response;
        public MsgsFile Feedback;
        ...
        public ActionFile(MsgFileLocation filename)
        {
            ...
            Request = new MsgsFile(new MsgFileLocation(filename.Path.Replace(".action", ".msg"), filename.searchroot), true, request, "\t");
            Response = new MsgsFile(new MsgFileLocation(filename.Path.Replace(".action", ".msg"), filename.searchroot), false, response, "\t");
            Feedback = new MsgsFile(new MsgFileLocation(filename.Path.Replace(".action", ".msg"), filename.searchroot), false, response, "\t");
        }
